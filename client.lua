...
local fonte = dxCreateFont ( ":fonts/components/Cargo_Two_SF.ttf" , 18 )
...
--Activity / MAXIME
					...
					local renk = tocolor(0, 0, 0, 200) -- rectangle renkleri
						if getElementData(theVehicle, "carshop") then
						exports.draw:gradient(px - 7.5, py+marg - 100,(recuzunluk + marg),65,0,0,0,255,false,true)
						exports.draw:gradient(px - 7.5, py+marg - 100,(recuzunluk + marg),24+(fontHeight+marg-7),0,0,0,255,false,true)
